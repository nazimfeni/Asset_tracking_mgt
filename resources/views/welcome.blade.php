                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-text-block">
                                <h2 class="text-white mb-2">Asset Tracking</h2>

                                <p class="text-white"> An asset tracking system is a technology-based solution designed to monitor and manage physical assets within an organization. These assets can include anything from vehicles, machinery, equipment, tools, IT hardware, inventory, and more. <a href="#" target="_parent">Tooplate website</a>. Images are from <a href="#" target="_blank">FreePik</a> website.</p>
